const tokens = {
  ...
  "colors.dark.bg": {
    value: "#16181D",
    variable: "var(--colors-dark-bg)",
  },
  "colors.dark.surface": {
    value: "#20222D",
    variable: "var(--colors-dark-surface)",
  },
  "colors.dark.border": {
    value: "#2B333B",
    variable: "var(--colors-dark-border)",
  },
  "spacing.0": {
    value: "0rem",
  ...
  "colors.destructive.hover": {
    value: "var(--colors-destructive-hover)",
    variable: "var(--colors-destructive-hover)",
  },
  "colors.muted": {
